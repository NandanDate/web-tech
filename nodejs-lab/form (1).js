...
app.get('/send',function(req,res){
    ...
    rr=rr+"<b>Enter your Name</b></br><input type='text', name='cust_name',value=' '></br></br>";
...
app.post('/details', urlencodedParser, function (req, res) {
    ...
    con.query(sql, function (err, result) {
        ...
        // Loop through the result and send each book entry
        result.forEach(function (row) {
            res.write("<h3><li>Customer Name: " + row.cname + "    |Customer Id: " + row.custId + "    |Room Number: " + row.room_no + "    |Alloted:" + row.alloted + "    |Age:" + row.age + "</li><h3>");
        });
